...
<body>
    <form action="">
        ...
        <div id="main-content" class="content"
            ...
            <h2 style="color: #df6915;">Xử phạt vi phạm giao thông </h2>
            <hr>
            <p>Chính phủ ban hành Nghị định 168/2024/NĐ-CP quy định xử phạt vi phạm hành chính về trật tự, an toàn giao
                thông trong lĩnh vực giao thông đường bộ; trừ điểm, phục hồi điểm giấy phép lái xe, có hiệu lực từ
                1/1/2025.</p>
            <image
            ...
            <ol>
                ...
                <p><strong>Lưu ý: </strong>Ngoài phạt tiền, người vi phạm còn bị tước giấy phép lái xe từ 1-2 tháng (lần
                    đầu) và từ 3-5 tháng (tái phạm).</p>
                <li>
            ...
            <ul>
                ...
                <li>Người tham gia giao thông cần tuân thủ nghiêm ngặt các quy định để đảm bảo an toàn cho bản thân và
                    cộng đồng.</li>
            </ul>
        </div>
        <footer class="footer">
