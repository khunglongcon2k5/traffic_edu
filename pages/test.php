    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <div class="button-group">
                <h4>Chọn đề thi:</h4>
                <button onclick="location.href='middle.php?exam_id=21'" class="center-button">20 Câu Hỏi Điểm
                    Liệt</button>
        ...
        font-size: 17px;"> Lưu ý: 8 x 25 = 200 câu hỏi, hoàn thành 8 bộ đề trên coi như bạn đã ôn trọn vẹn tất cả các
                    câu hỏi ôn thi A1.
                    Tuy nhiên, bạn có thể ôn thêm 20 bộ đề cấu trúc A1 chuẩn của chúng tôi, mỗi bộ đề có 1 câu điểm
                    liệt, cấu trúc sẽ giống với đề thi
                    thật nhất, chỉ khác đề thi thật chọn ngẫu nhiên câu hỏi, không bộ đề nào giống bộ đề nào, còn chúng
                    tôi cố định từng đề để các bạn
                    tiện hỏi đáp hơn.</p>
